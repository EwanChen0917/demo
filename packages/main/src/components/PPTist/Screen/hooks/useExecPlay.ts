...
import { ANIMATION_CLASS_PREFIX } from '@/components/PPTist/configs/animation';
...
export default () => {
  ...
  const execPrev = () => {
    ...
    } else if (loopPlay.value) turnSlideToIndex(slides.value.length - 1);
