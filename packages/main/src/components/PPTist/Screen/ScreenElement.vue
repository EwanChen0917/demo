<template>
  ...
  >
    <component :is="currentElementComponent" :elementInfo="elementInfo" />
  </div>
</template>
...
<script lang="ts" setup>
  ...
  import ScreenVideoElement from '@/components/PPTist/components/element/VideoElement/ScreenVideoElement.vue';
  import ScreenAudioElement from '@/components/PPTist/components/element/AudioElement/ScreenAudioElement.vue';
