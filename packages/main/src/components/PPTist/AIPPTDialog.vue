  ...
  <div class="aippt-dialog">
    <div class="header">
      ...
      <span class="subtite" v-if="step === 'template'">
        从下方挑选合适的模板生成PPT，或
        <span class="local" v-tooltip="'上传.pptist格式模板文件'" @click="uploadLocalTemplate()">
          使用本地模板生成
        </span>
      </span>
      ...
      <span class="subtite" v-else>
        在下方输入您的PPT主题，并适当补充信息，如行业、岗位、学科、用途等
      </span>
    </div>
...
<script lang="ts" setup>
  ...
  import useAIPPT from '@/components/PPTist/hooks/useAIPPT';
  ...
  import OutlineEditor from '@/components/PPTist/components/OutlineEditor.vue';
  import Checkbox from '@/components/PPTist/components/Checkbox.vue';
  import type { Slide, SlideTheme } from '@/components/PPTist/types/slides';
  import type { AIPPTSlide } from '@/components/PPTist/types/AIPPT';
  import { decrypt } from '@/components/PPTist/utils/crypto';
