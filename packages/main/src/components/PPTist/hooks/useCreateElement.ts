...
import { getImageSize } from '@/components/PPTist/utils/image';
import { type ShapePoolItem, SHAPE_PATH_FORMULAS } from '@/components/PPTist/configs/shapes';
import type { LinePoolItem } from '@/components/PPTist/configs/lines';
import { CHART_DEFAULT_DATA } from '@/components/PPTist/configs/chart';
