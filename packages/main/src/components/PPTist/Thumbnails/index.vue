<template>
  ...
  >
    ...
    <Draggable
      ...
      :disabled="editingSectionId || isShare"
      @end="handleDragEnd"
      itemKey="id"
    >
...
<script lang="ts" setup>
  ...
  import useSectionHandler from '@/components/PPTist/hooks/useSectionHandler';
  import useScreening from '@/components/PPTist/hooks/useScreening';
  import useLoadSlides from '@/components/PPTist/hooks/useLoadSlides';
  import useAddSlidesOrElements from '@/components/PPTist/hooks/useAddSlidesOrElements';
  import Draggable from 'vuedraggable';
  import type { Slide } from '@/components/PPTist/types/slides';
  import { isElementInViewport } from '@/components/PPTist/utils/element';
  import type { ContextmenuItem } from '@/components/PPTist/components/Contextmenu/types';

  import ThumbnailSlide from '@/components/PPTist/components/ThumbnailSlide/index.vue';
  ...
  const handleClickSlideThumbnail = (e: MouseEvent, index: number) => {
    ...
    if (ctrlKeyState.value) {
      ...
      } else if (selectedSlidesIndex.value.includes(index)) {
        const newSelectedSlidesIndex = selectedSlidesIndex.value.filter((item) => item !== index);
        mainStore.updateSelectedSlidesIndex(newSelectedSlidesIndex);
      } else {
