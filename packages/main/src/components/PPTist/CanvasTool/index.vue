...
<script lang="ts" setup>
  ...
  import type { ShapePoolItem } from '@/components/PPTist/configs/shapes';
  import type { LinePoolItem } from '@/components/PPTist/configs/lines';

  import LaTeXEditor from '@/components/PPTist/components/LaTeXEditor/index.vue';
  ...
  const { scaleCanvas, setCanvasScalePercentage, resetCanvas, canvasScalePercentage } =
    useScaleCanvas();
