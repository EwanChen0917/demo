  ...
  <div class="multi-style-panel">
    <div class="row">
      ...
      <Popover trigger="click" style="width: 60%">
        <template #content>
          <ColorPicker :modelValue="fill" @update:model-value="(value) => updateFill(value)" />
        </template>
      ...
      <Popover trigger="click" style="width: 60%">
        <template #content>
          <ColorPicker
            ...
            @update:model-value="(value) => updateOutline({ color: value })"
          />
        </template>
      ...
      <Popover trigger="click" style="width: 30%">
        <template #content>
          <ColorPicker
            ...
            @update:model-value="(value) => updateFontStyle('color', value)"
          />
        </template>
      ...
      <Popover trigger="click" style="width: 30%">
        <template #content>
          <ColorPicker
            ...
            @update:model-value="(value) => updateFontStyle('backcolor', value)"
          />
        </template>
