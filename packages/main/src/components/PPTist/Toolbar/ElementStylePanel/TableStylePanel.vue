      ...
      <Popover trigger="click" style="width: 50%">
        <template #content>
          <ColorPicker
            ...
            @update:model-value="(value) => updateTextAttrs({ color: value })"
          />
        </template>
      ...
      <Popover trigger="click" style="width: 50%">
        <template #content>
          <ColorPicker
            ...
            @update:model-value="(value) => updateTextAttrs({ backcolor: value })"
          />
        </template>
        ...
        <Popover trigger="click" style="width: 60%">
          <template #content>
            <ColorPicker
              ...
              @update:model-value="(value) => updateTheme({ color: value })"
            />
          </template>
...
<script lang="ts" setup>
  ...
  import Checkbox from '@/components/PPTist/components/Checkbox.vue';
  ...
  const fontSizeOptions = ['12px', '14px', '16px', '18px', '20px', '22px', '24px', '28px', '32px'];
  ...
  const updateTextAttrState = () => {
    ...
    const { style } = handleElement.value.data[rowIndex][colIndex];
