        ...
        <Popover trigger="click" style="width: 60%">
          <template #content>
            <ColorPicker
              ...
              @update:model-value="(value) => updateGradientColors(value)"
            />
          </template>
...
<script lang="ts" setup>
  ...
  import useShapeFormatPainter from '@/components/PPTist/hooks/useShapeFormatPainter';
  ...
  import {
    ...
    SHAPE_LIST,
    SHAPE_PATH_FORMULAS,
  } from '@/components/PPTist/configs/shapes';
  ...
  import ShapeItemThumbnail from '@/components/PPTist/CanvasTool/ShapeItemThumbnail.vue';
