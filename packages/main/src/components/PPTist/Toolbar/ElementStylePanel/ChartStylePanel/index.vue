    ...
    <div class="row">
      ...
      <Popover trigger="click" style="width: 60%">
        <template #content>
          <ColorPicker
            :modelValue="fill"
            @update:model-value="(value) => updateElement({ fill: value })"
          />
        </template>
      ...
      <Popover trigger="click" style="width: 60%">
        <template #content>
          <ColorPicker
            ...
            @update:model-value="(value) => updateElement({ textColor: value })"
          />
        </template>
      ...
      <Popover trigger="click" style="width: 60%">
        <template #content>
          <ColorPicker
            ...
            @update:model-value="(value) => updateElement({ lineColor: value })"
          />
        </template>
...
<script lang="ts" setup>
  ...
  import { CHART_PRESET_THEMES } from '@/components/PPTist/configs/chart';
  ...
  watch(
    ...
    () => {
      ...
      if (handleElement.value.options) {
        const { lineSmooth: _lineSmooth, stack: _stack } = handleElement.value.options;
