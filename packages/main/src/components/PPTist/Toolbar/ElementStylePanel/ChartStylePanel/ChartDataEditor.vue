...
<script lang="ts" setup>
  ...
  import type { ChartData, ChartType } from '@/components/PPTist/types/slides';
  ...
  } from '@/components/PPTist/utils/clipboard';
  import { CHART_TYPE_MAP } from '@/components/PPTist/configs/chart';
  ...
  const changeSelectRange = (e: MouseEvent) => {
    ...
    document.onmouseup = (e) => {
      ...
      let { width } = tempRangeSize.value;
      let { height } = tempRangeSize.value;
