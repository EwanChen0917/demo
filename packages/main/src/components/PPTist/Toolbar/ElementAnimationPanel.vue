<template>
  <div class="element-animation-panel">
    ...
    <div class="tip" v-else>
      <IconClick style="margin-right: 5px" />
      选中画布中的元素添加动画
    </div>
    ...
    >
      <template #item="{ element }">
        <div
          class="sequence-item"
          :class="[element.type, { active: handleElement?.id === element.elId }]"
        >
...
<script lang="ts" setup>
  ...
  } from '@/components/PPTist/configs/animation';
  import { ELEMENT_TYPE_ZH } from '@/components/PPTist/configs/element';
