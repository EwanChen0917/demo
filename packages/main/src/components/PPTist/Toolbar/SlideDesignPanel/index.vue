        ...
        <Popover trigger="click" style="width: 60%">
          <template #content>
            <ColorPicker
              ...
              @update:model-value="(value) => updateGradientBackgroundColors(value)"
            />
          </template>
      ...
      <Popover trigger="click" style="width: 60%">
        <template #content>
          <ColorPicker
            ...
            @update:model-value="(value) => updateTheme({ backgroundColor: value })"
          />
        </template>
        ...
        <Popover trigger="click" style="width: 60%">
          <template #content>
            <ColorPicker
              ...
              @update:model-value="
                (value) => updateTheme({ outline: { ...theme.outline, color: value } })
              "
            />
          </template>
        ...
        <Popover trigger="click" style="width: 60%">
          <template #content>
            <ColorPicker
              ...
              @update:model-value="
                (value) => updateTheme({ shadow: { ...theme.shadow, color: value } })
              "
            />
          </template>
...
<script lang="ts" setup>
  ...
  import useSlideTheme from '@/components/PPTist/hooks/useSlideTheme';
  ...
  import { getImageDataURL } from '@/components/PPTist/utils/image';
  import { PRESET_THEMES } from '@/components/PPTist/configs/theme';
  import { FONTS } from '@/components/PPTist/configs/font';

  import ColorListButton from '@/components/PPTist/components/ColorListButton.vue';
  ...
  import Slider from '@/components/PPTist/components/Slider.vue';
  import Popover from '@/components/PPTist/components/Popover.vue';
  import SelectCustom from '@/components/PPTist/components/SelectCustom.vue';
  import NumberInput from '@/components/PPTist/components/NumberInput.vue';
  import Modal from '@/components/PPTist/components/Modal.vue';
  import GradientBar from '@/components/PPTist/components/GradientBar.vue';
