  ...
  <div class="rich-text-base">
      ...
      <Popover trigger="click" style="width: 30%">
        <template #content>
          <ColorPicker
            ...
            @update:model-value="(value) => emitRichTextCommand('backcolor', value)"
          />
        </template>
    ...
    <ButtonGroup class="row" passive>
      <Popover trigger="click" v-model:value="AIPopoverVisible" style="width: 25%">
        ...
        <CheckboxButton first style="width: 100%" v-tooltip="'AI辅助'">
          <span :class="{ 'ai-loading': isAIWriting }">{{ isAIWriting ? '' : 'AI' }}</span>
        </CheckboxButton>
      </Popover>
      <CheckboxButton style="flex: 1" v-tooltip="'清除格式'" @click="emitRichTextCommand('clear')">
        <IconFormat />
      </CheckboxButton>
      <CheckboxButton
        style="flex: 1"
    ...
    >
      <RadioButton value="left" v-tooltip="'左对齐'" style="flex: 1">
        <IconAlignTextLeft />
      </RadioButton>
      <RadioButton value="center" v-tooltip="'居中'" style="flex: 1">
        <IconAlignTextCenter />
      </RadioButton>
      <RadioButton value="right" v-tooltip="'右对齐'" style="flex: 1">
        <IconAlignTextRight />
      </RadioButton>
      <RadioButton value="justify" v-tooltip="'两端对齐'" style="flex: 1">
        <IconAlignTextBoth />
      </RadioButton>
    </RadioGroup>
...
<script lang="ts" setup>
  ...
  import useTextFormatPainter from '@/components/PPTist/hooks/useTextFormatPainter';
  import TextColorButton from '@/components/PPTist/components/TextColorButton.vue';
  ...
  import Select from '@/components/PPTist/components/Select.vue';
  import emitter, { EmitterEvents } from '@/components/PPTist/utils/emitter';
  import message from '@/components/PPTist/utils/message';
  import { htmlToText } from '@/components/PPTist/utils/common';
  import { FONTS } from '@/components/PPTist/configs/font';
  ...
  import RadioButton from '@/components/PPTist/components/RadioButton.vue';
  import RadioGroup from '@/components/PPTist/components/RadioGroup.vue';
  import SelectGroup from '@/components/PPTist/components/SelectGroup.vue';
  import Popover from '@/components/PPTist/components/Popover.vue';
  import api from '@/components/PPTist/services';
  import PopoverMenuItem from '@/components/PPTist/components/PopoverMenuItem.vue';

  const { handleElement, handleElementId, richTextAttrs, textFormatPainter } = storeToRefs(
    useMainStore()
  );
