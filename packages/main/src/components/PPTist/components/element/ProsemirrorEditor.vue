...
<script lang="ts" setup>
  ...
  import { useKeyboardStore, useMainStore } from '@/store/modules';
  import type { EditorView } from 'prosemirror-view';
  import { toggleMark, wrapIn, lift } from 'prosemirror-commands';
  import { initProsemirrorEditor, createDocument } from '@/components/PPTist/utils/prosemirror';
  import {
    ...
    markActive,
    getFontsize,
  } from '@/components/PPTist/utils/prosemirror/utils';
  import emitter, {
    EmitterEvents,
    type RichTextAction,
    type RichTextCommand,
  } from '@/components/PPTist/utils/emitter';
  import { alignmentCommand } from '@/components/PPTist/utils/prosemirror/commands/setTextAlign';
  import {
    indentCommand,
    textIndentCommand,
  } from '@/components/PPTist/utils/prosemirror/commands/setTextIndent';
  import { toggleList } from '@/components/PPTist/utils/prosemirror/commands/toggleList';
  import { setListStyle } from '@/components/PPTist/utils/prosemirror/commands/setListStyle';
  import { replaceText } from '@/components/PPTist/utils/prosemirror/commands/replaceText';
  import message from '@/components/PPTist/utils/message';
  import type { TextFormatPainterKeys } from '@/components/PPTist/types/edit';
  ...
  const { handleElementId, textFormatPainter, richTextAttrs, activeElementIdList } =
