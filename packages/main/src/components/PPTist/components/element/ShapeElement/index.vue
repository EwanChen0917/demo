...
<script lang="ts" setup>
  ...
  import { useMainStore, useSlidesStore } from '@/store/modules';
  import type { PPTShapeElement, ShapeText } from '@/components/PPTist/types/slides';
  import useElementOutline from '@/components/PPTist/components/element/hooks/useElementOutline';
  import useElementShadow from '@/components/PPTist/components/element/hooks/useElementShadow';
  import useElementFlip from '@/components/PPTist/components/element/hooks/useElementFlip';
  import useElementFill from '@/components/PPTist/components/element/hooks/useElementFill';
  import ProsemirrorEditor from '@/components/PPTist/components/element/ProsemirrorEditor.vue';
  ...
  const prosemirrorEditorRef =
    useTemplateRef<InstanceType<typeof ProsemirrorEditor>>('prosemirrorEditorRef');
  const startEdit = () => {
    editable.value = true;
