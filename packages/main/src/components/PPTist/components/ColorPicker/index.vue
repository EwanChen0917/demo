<template>
  <div class="color-picker">
    <div class="picker-saturation-wrap">
      <Saturation :value="color" :hue="hue" @color-change="(value) => changeColor(value)" />
    </div>
    <div class="picker-controls">
      ...
      <div class="picker-sliders">
        <div class="picker-hue-wrap">
          <Hue :value="color" :hue="hue" @color-change="(value) => changeColor(value)" />
        </div>
        <div class="picker-alpha-wrap">
          <Alpha :value="color" @color-change="(value) => changeColor(value)" />
        </div>
      </div>
    </div>

    <div class="picker-field">
      <EditableInput class="input" :value="color" @color-change="(value) => changeColor(value)" />
