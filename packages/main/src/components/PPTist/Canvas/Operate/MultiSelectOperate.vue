...
<script lang="ts" setup>
  ...
  import type { OperateResizeHandlers, MultiSelectRange } from '@/components/PPTist/types/edit';
  import { getElementListRange } from '@/components/PPTist/utils/element';
  ...
  const localActiveElementList = computed(() =>
    props.elementList.filter((el) => activeElementIdList.value.includes(el.id))
  );
