<template>
  ...
  >
    ...
    >
      <div class="index-item" v-for="index in elementIndexListInAnimation" :key="index">
        {{ index + 1 }}
      </div>
    </div>
...
<script lang="ts" setup>
  ...
  import type { OperateLineHandlers, OperateResizeHandlers } from '@/components/PPTist/types/edit';
