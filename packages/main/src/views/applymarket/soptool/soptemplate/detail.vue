<template>
  <div class="packing-detail-page" v-loading="detailLoading">
...
<script setup lang="ts" name="soptemplatedetail">
  ...
  const { loading: detailLoading, run: getDetailData } = useRequest(
    sopApi.luteosSopQueryTemplateDetail,
    {
      manual: true,
      async onSuccess(data) {
        data.stepList?.forEach((item: any) => {
