    ...
    <el-row :gutter="20">
      <el-col :lg="7" :md="12" :sm="24" :offset="0">
        <KeenCard title="审核流信息">
          ...
          <el-form-item label="单据类型：">{{ form?.baseInfo.typeDesc }}</el-form-item>
          <el-form-item label="审核类型：">
            {{ form?.baseInfo.auditType === 1 ? '系统审核' : '钉钉审核' }}
          </el-form-item>
        </KeenCard>
        <KeenCard title="选择条件">
          <el-form-item
      ...
      <el-col :lg="17" :md="12" :sm="24" :offset="0" v-if="form.baseInfo.auditType === 1">
...
<script setup lang="ts" name="salesForecastingSettingAuditRuleDetail">
