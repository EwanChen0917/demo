    ...
    <div class="card card-flush">
      <div class="card-header align-items-center gap-2 gap-md-5">
        <div class="card-title">
          <el-input
            ...
            placeholder="产品SKU/供应链产品SKU/产品名称"
            clearable
            style="width: 300px"
      ...
      <div class="card-body pt-0">
        ...
        >
          ...
          <el-table-column label="库存详情" fixed="right" min-width="80" v-show="props?.showdetail">
            <template #default="{ row }">
              <KeenActions
...
<script setup lang="ts">
  ...
  import supplySkuStockDetailDialog from '@/views/supplyChainManage/B2BOrder/shopifyOrder/components/supplySkuStockDetailDialog.vue';
