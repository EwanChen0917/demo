<template>
  <el-dialog align-center :model-value="visible" @close="$emit('close')" width="55%" top="1vh">
    <template #header>
    ...
    <div class="card-body pt-0 tablewrap">
      <el-table
        ...
        :data="listData?.supplySkuItemList"
      ...
      >
        ...
        <!-- <template> -->
        <el-table-column prop="warehouseDesc" label="发货仓" min-width="140" />
...
<script lang="ts" setup>
  ...
  import { ProductContracts, omsApi, OmsApi } from '@/api/index';
  ...
  >({
    searchDefaults: {
      ...
      supplySkuList: [props?.sku?.supplySku],
      pageNum: 1,
      pageSize: 100,
      searchInventory: true,
    ...
    service: omsApi.omsCommonStockQuerySupplySkuStock,
  });
