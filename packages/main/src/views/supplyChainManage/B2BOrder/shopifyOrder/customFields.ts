const customFields = [
  ...
  },
  {
    ...
    propertyArr: [
      ...
      { key: 'salesFreightAmount', label: '订单买家支付运费', checked: true },
  ...
  },
  {
    title: '时间',
    propertyArr: [
      { key: 'payTime', label: '付款', checked: true, readonly: true },
      { key: 'sendTime', label: '发货', checked: true },
      { key: 'osAuthTime', label: '审核', checked: true },
    ],
  },
];
