<template>
  ...
  >
    ...
    <el-row :gutter="20" style="margin-left: 0 !important; background: white">
      <EditLayout :formModel="conditionList" :schema="schema as any" ref="editLayoutRef">
        <template #custom-receiveCode="{ model, formModel }">
          <el-form-item :label="model.label" required>
        ...
        <template #actions>
          ...
          <el-form-item label="标发规则" label-width="190px" inline required>
            <el-radio-group v-model="formModel.actionParams.sendMarkShipped">
              <el-radio :value="1">自动标发</el-radio>
              <el-radio :value="0">无需标发</el-radio>
            </el-radio-group>
          </el-form-item>
        </template>
      </EditLayout>
...
<script setup lang="ts">
  ...
  import { useTrenderRuleData } from './hooks/useSelfRuleData';
  import {
    QuestionFilled,
    InfoFilled,
    CaretTop,
