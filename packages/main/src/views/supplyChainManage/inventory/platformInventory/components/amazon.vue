<template>
  ...
  >
    ...
    <template #filters>
      <el-select placeholder="店铺名称" v-model="search.amazonShopCode" filterable clearable>
    ...
    <template #buttons>
      <ExportBtn :service="erpApi.luteosErpInventoryAmazonPlatformListExport" :params="search">
        导出
      </ExportBtn>
    </template>
    <el-table
    ...
    >
      ...
      <el-table-column label="店铺账号" prop="userAccount" min-width="120" />
...
<script setup lang="ts">
  ...
  >({
    ...
    pageSize: PAGE_SIZE,
    service: erpApi.luteosErpInventoryAmazonQueryPlatformList,
  });
