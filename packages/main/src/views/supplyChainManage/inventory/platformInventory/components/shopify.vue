<template>
  ...
  >
    ...
    <template #buttons>
      <ExportBtn :service="erpApi.luteosErpInventoryShopifyPlatformListExport" :params="search">
        导出
      </ExportBtn>
    </template>
    <el-table
    ...
    >
      ...
      <el-table-column label="仓库名称" prop="userAccount" min-width="150" />
...
<script setup lang="ts">
  ...
  const {
    ...
    ErpApi.LuteosErpInventoryShopifyQueryPlatformList.RequestQuery,
    ErpApi.LuteosErpInventoryShopifyQueryPlatformList.ResponseBody
  >({
    searchDefaults: {
      keyword: undefined,
    ...
    pageSize: PAGE_SIZE,
    service: erpApi.luteosErpInventoryShopifyQueryPlatformList,
  });
