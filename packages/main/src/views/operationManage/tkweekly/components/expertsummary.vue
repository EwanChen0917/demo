<template>
  ...
  >
    ...
    <template #buttons>
      <ExportBtn :service="productApi.luteosProductTiktokExportMetaTiktokSumList" :params="search">
        导出
      </ExportBtn>
    </template>
...
<script lang="ts" setup>
  ...
  const {
    ...
    ProductApi.LuteosProductTiktokQueryMetaTiktokSumList.RequestQuery,
    ProductApi.LuteosProductTiktokQueryMetaTiktokSumList.ResponseBody
  >({
    searchDefaults: {
      keyword: undefined,
      videoYear: undefined,
    ...
    pageSize: PAGE_SIZE,
    service: productApi.luteosProductTiktokQueryMetaTiktokSumList,
  });
  const reset = () => {
    resetSearch();
    videoYear.value = '';
