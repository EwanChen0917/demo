<template>
  ...
  >
    ...
    <el-table ref="tableRef" v-loading="listLoading" :data="listData?.recordList">
      ...
      <el-table-column label="币别" prop="targetExt1" />
      <el-table-column label="仓库" prop="target" />
      <el-table-column label="金蝶部门编码" prop="targetExt2" />
...
<script setup lang="ts" name="shopMap">
  import useList from '@/hooks/list/useList';
  import { PlatformApi, platformApi } from '@/api';
  import { ElMessage } from 'element-plus';
  import * as swal from '@/utils/swal';
  import EditDialog from '@/views/finance/shopMap/components/editDialog.vue';
