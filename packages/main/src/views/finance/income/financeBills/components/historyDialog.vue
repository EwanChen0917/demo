...
<script setup lang="ts">
  ...
  const {
    ...
    FinanceSystemApi.FinancePlatformOrderQueryPushBatchList.RequestBody,
    FinanceSystemApi.FinancePlatformOrderQueryPushBatchList.ResponseBody
  >({
    searchDefaults: {
      keyword: undefined,
    },
    ...
    pageSize: PAGE_SIZE,
    service: financeSystemApi.financePlatformOrderQueryPushBatchList,
  });
