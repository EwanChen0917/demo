...
export const pushStatusMap = [
  { name: '未推送', value: pushStatus.未推送 },
  { name: '推送中', value: pushStatus.推送中 },
  { name: '已推送', value: pushStatus.已推送 },
  { name: '推送失败', value: pushStatus.推送失败 },
];

export const pushStatusMapList = {
  [pushStatus.未推送]: '未推送',
  [pushStatus.推送中]: '推送中',
  [pushStatus.已推送]: '已推送',
