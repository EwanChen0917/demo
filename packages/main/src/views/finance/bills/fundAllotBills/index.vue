    ...
    >
      <template #search>
        <el-input
          ...
          placeholder="单据编号/来源单号/金蝶单号/申请人/备注"
          class="w-350px"
          clearable
        >
          <template #prefix>
      ...
      >
        ...
        <el-table-column label="转出组织" prop="transferOutOrgDesc" min-width="120" />
        <el-table-column label="来源单号" prop="sourceCode" min-width="120" />
        <el-table-column label="申请人" prop="applyMemberDesc" />
        <el-table-column label="业务日期" prop="businessDate" />
        <el-table-column label="单据状态" prop="statusDesc" />
        <el-table-column label="备注" prop="remark" />
        <el-table-column label="金蝶编号" prop="kingdeePushInfo">
...
<script setup lang="ts" name="fundAllotBills">
  ...
  const {
    ...
    FinanceSystemContracts.TransferSlipListQueryResp
  >({
    searchDefaults: {
      keyword: undefined,
    ...
    pageSize: PAGE_SIZE,
    service: financeSystemApi.financeTransferSlipQueryList,
  });
