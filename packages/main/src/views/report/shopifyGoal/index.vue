...
<script setup lang="ts" name="shopifyGoal">
  ...
  const getPermission = ({ type }) => {
    switch (type) {
      ...
      case 'edit':
      case 'delete':
        return checkPermission('shopifyGoal-edit');
      default:
        return false;
    }
  };
  ...
  const iframeSrc = ref(
    'https://finebi.luteos.com/webroot/decision/v5/design/report/75ef5d6e8b974189bad60c51b61848eb/view'
  );
