        ...
        <aside class="sidebar" :style="{ display: sidebarVisible ? 'block' : 'none' }">
          ...
          <div class="analysis-panel">
            <LtAnalysisReport
              ...
              :report-type="WeeklyReportType.AmazonDayReport"
              :btn-list="[
                {
                  label: '创建报告',
                  reportType: WeeklyReportType.AmazonDayReport,
                },
                {
                  label: '创建周总结',
                  reportType: WeeklyReportType.AmazonDaySummarizeReport,
                },
              ]"
              :branch="form.branch"
...
<script setup lang="ts" name="amazonDayReport">
  ...
  const getOptions = async () => {
    const res = await mpcWeeklyReportApi.luteosMarketWeekReportQueryOptions({
      platform: 'lute_erp',
      componentName: 'amazonDayOptions', // 每个功能模块的标识
    });
