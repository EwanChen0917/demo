...
<script setup lang="ts" name="tiktokGoal">
  ...
  const getPermission = ({ type }) => {
    switch (type) {
      ...
      case 'edit':
      case 'delete':
        return checkPermission('tiktokGoal-edit');
      default:
        return false;
    }
  };
  ...
  const iframeSrc = ref(
    'https://finebi.luteos.com/webroot/decision/v5/design/report/78f8a59d4e764164bb7f47005a312e71/view'
  );
