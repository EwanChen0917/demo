  ...
  <div class="core-indicators no-padding" v-loading="loading">
    <div class="core-indicators__cards">
      ...
      <div class="core-indicators__card">
        <div class="card-header-content">
          ...
          <div class="card-trend">
            <CoreDataEchart
              ...
              :color="healthColor[detailData.coreIndicator.salesAmount?.healthLevel]"
            />
          </div>
        </div>
        ...
        <template v-if="searchParams.dateType !== 'week'">
          <el-progress
        ...
        <div class="card-header-content">
          ...
          <div class="card-trend">
            <CoreDataEchart
              ...
              :color="healthColor[detailData.coreIndicator.revenueAmount?.healthLevel]"
            />
          </div>
        </div>
        <div class="card-compare">
      ...
      <div class="core-indicators__card">
        <div class="card-header-content">
          ...
          <div class="card-trend">
            <CoreDataEchart
              ...
              :color="healthColor[detailData.coreIndicator.grossProfitAmount?.healthLevel]"
            />
          </div>
        </div>
        <div class="card-compare">
        ...
        <template v-if="searchParams.dateType !== 'week'">
          ...
          >
            ...
            >
              <SvgIcon
                :icon="HealthLevel[detailData.coreIndicator.grossProfitAmount?.healthLevel]"
              />
              <span>
        ...
        <div class="card-header-content">
          ...
          <div class="card-trend">
            <CoreDataEchart
              ...
              :color="healthColor[detailData.coreIndicator.grossProfitRate?.healthLevel]"
            />
          </div>
        </div>
        <div class="card-compare">
          ...
          <div class="card-footer">
            ...
            >
              <span class="card-healthy-content">
                <SvgIcon
                  :icon="HealthLevel[detailData.coreIndicator.grossProfitRate?.healthLevel]"
                />
                <span>
        ...
        <div class="card-header-content">
          ...
          <div class="card-trend">
            <CoreDataEchart
              ...
              :color="healthColor[detailData.coreIndicator.refundRate?.healthLevel]"
            />
          </div>
        </div>
        <div class="card-compare">
      ...
      <div class="core-indicators__card">
        <div class="card-header-content">
          <div>
            <div class="card-header">
              <span class="card-title">成交均价</span>
            </div>
            <div class="card-value">
              {{
                [undefined, null].includes(detailData.coreIndicator.avgSalesAmount?.amount)
                  ? '-'
                  : Math.ceil(detailData.coreIndicator.avgSalesAmount.amount)
              }}
          ...
          <div class="card-trend">
            <CoreDataEchart
              v-if="detailData.coreIndicator.avgSalesAmount?.trendList"
              :data="detailData.coreIndicator.avgSalesAmount.trendList"
              color="#FF9F22"
            />
          </div>
        </div>
        <div class="card-compare">
          ...
          <svg
            class="arrow"
            :class="[detailData.coreIndicator.avgSalesAmount?.monthlyGrowth >= 0 ? 'up' : 'down']"
            width="12"
            height="12"
            viewBox="0 0 12 12"
          >
          ...
          <span
            ...
            :class="[detailData.coreIndicator.avgSalesAmount?.monthlyGrowth >= 0 ? 'up' : 'down']"
          >
            {{ formatPercent(detailData.coreIndicator.avgSalesAmount?.monthlyGrowth) }}%
          </span>
          <span class="divider"></span>
          <span>同比</span>
          <svg
            class="arrow"
            :class="[detailData.coreIndicator.avgSalesAmount?.yearlyGrowth >= 0 ? 'up' : 'down']"
            width="12"
            height="12"
            viewBox="0 0 12 12"
          >
          ...
          <span
            ...
            :class="[detailData.coreIndicator.avgSalesAmount?.yearlyGrowth >= 0 ? 'up' : 'down']"
          >
            {{ formatPercent(detailData.coreIndicator.avgSalesAmount?.yearlyGrowth) }}%
          </span>
        </div>
      </div>
      ...
      <div class="core-indicators__card">
        <div class="card-header-content">
          <div>
            <div class="card-header">
              <span class="card-title">推广费率</span>
            </div>
            <div class="card-value">
              {{ formatPercent(detailData.coreIndicator.adCostRate?.rate) }}
              <span class="card-unit">%</span>
            </div>
          </div>
          <div class="card-trend">
            <CoreDataEchart
              v-if="detailData.coreIndicator.adCostRate?.trendList"
              :data="detailData.coreIndicator.adCostRate.trendList"
              color="#02B96B"
            />
          </div>
        </div>
        <div class="card-compare">
          ...
          <svg
            class="arrow"
            :class="[detailData.coreIndicator.adCostRate?.monthlyGrowth >= 0 ? 'up' : 'down']"
            width="12"
            height="12"
            viewBox="0 0 12 12"
          >
          ...
          <span
            ...
            :class="[detailData.coreIndicator.adCostRate?.monthlyGrowth >= 0 ? 'up' : 'down']"
          >
            {{ formatPercent(detailData.coreIndicator.adCostRate?.monthlyGrowth) }}%
          </span>
          <span class="divider"></span>
          <span>同比</span>
          <svg
            class="arrow"
            :class="[detailData.coreIndicator.adCostRate?.yearlyGrowth >= 0 ? 'up' : 'down']"
            width="12"
            height="12"
            viewBox="0 0 12 12"
          >
          ...
          <span
            ...
            :class="[detailData.coreIndicator.adCostRate?.yearlyGrowth >= 0 ? 'up' : 'down']"
          >
            {{ formatPercent(detailData.coreIndicator.adCostRate?.yearlyGrowth) }}%
          </span>
        </div>
      </div>
      <!-- 库存周转天数 -->
      <div class="core-indicators__card">
        <div class="card-header-content">
          <div>
            ...
            <div class="card-value">
              {{ formatNumber(detailData.coreIndicator.inventoryTurnoverDays?.amount, 2) }}
            </div>
          </div>
          <div class="card-trend">
            <CoreDataEchart
      ...
      <div class="core-indicators__card">
        <div class="card-header-content">
          <div>
            <div class="card-header">
              <span class="card-title">上架项目数</span>
            </div>
            <div class="card-value">
              {{ formatNumber(detailData.coreIndicator.listingCount?.count) }}
              <span class="card-unit">个</span>
            </div>
          </div>
          <div class="card-trend">
            <CoreDataEchart
              v-if="detailData.coreIndicator.listingCount?.trendList"
              :data="detailData.coreIndicator.listingCount.trendList"
              color="#02B96B"
            />
          </div>
        </div>
        <div class="card-compare">
          <span>如期&nbsp;</span>
          <span class="rate">{{ detailData.coreIndicator.listingCount?.normalCount }}个</span>
          <span class="divider"></span>
          <span>延期&nbsp;</span>

          <span class="rate">{{ detailData.coreIndicator.listingCount?.delayedCount }}个</span>
        </div>
      </div>
      <!-- 评分 -->
      <div class="core-indicators__card">
        <div class="card-header-content">
          <div>
            ...
            <div class="card-value">
              {{
                ...
                }).format(detailData.coreIndicator.score?.amount)
              }}
          ...
          <div class="card-trend">
            <CoreDataEchart
              v-if="detailData.coreIndicator.score?.trendList"
              :data="detailData.coreIndicator.score.trendList"
              color="#02B96B"
            />
          </div>
        </div>
        <div class="card-compare">
          <span>较上期差值&nbsp;</span>
          <span class="rate" :class="[detailData.coreIndicator.score?.diff >= 0 ? 'up' : 'down']">
            {{
              Intl.NumberFormat('zh-CN', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 2,
              }).format(detailData.coreIndicator.score?.diff)
            }}分
          </span>
        </div>
      </div>
