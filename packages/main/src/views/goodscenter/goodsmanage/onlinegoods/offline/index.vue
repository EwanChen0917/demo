<template>
  ...
  >
    <template #search>
      <el-space>
        <el-input
          ...
          placeholder="请输入产品SPU/skuCode/productSku"
          clearable
          style="width: 275px"
        >
          <template #prefix>
    ...
    <template #buttons>
      ...
      <ExportBtn :service="channelProductApi.luteosChannelProductExportProduct" :params="search">
        导出
      </ExportBtn>
    </template>
    <el-table
