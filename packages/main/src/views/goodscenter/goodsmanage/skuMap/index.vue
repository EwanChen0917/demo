<template>
  ...
  >
    ...
    <template #buttons>
      ...
      <ExportBtn :service="productApi.luteosProductSkuMappingExportList" :params="search">
        导出
      </ExportBtn>
    </template>
    <el-table
...
<script setup lang="ts" name="skumap">
  ...
  import EditDialog from '@/views/goodscenter/goodsmanage/skuMap/components/editDialog.vue';
  import Log from '@/views/goodscenter/goodsmanage/skuMap/components/log.vue';
