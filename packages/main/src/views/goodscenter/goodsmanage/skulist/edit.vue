    ...
    <KeenCard title="基础信息">
      ...
      <div class="item-grid">
        ...
        <el-form-item label="计划专员：" prop="plannerName">
          <el-input v-model="form.plannerName" clearable disabled />
        </el-form-item>
        ...
        <el-form-item label="适用周期:">
          <el-input v-model="form.applicablePeriod" clearable placeholder="请输入" />
        </el-form-item>
      </div>
      ...
      <el-form-item label="卖点：">
        <el-input type="textarea" v-model="form.sellingPoint" clearable :rows="5" disabled />
      </el-form-item>
      <el-form-item label="在线完整产品规格（要点）：">
        <el-input type="textarea" v-model="form.onlineFullProductSpecs" clearable :rows="5" />
      </el-form-item>
      <el-form-item label="备注：">
        <el-input type="textarea" v-model="form.remark" clearable :rows="5" />
      </el-form-item>
    </KeenCard>
