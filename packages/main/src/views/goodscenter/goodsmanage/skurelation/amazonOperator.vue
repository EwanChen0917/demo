<template>
  ...
  >
    ...
    <template #buttons>
      <ExportBtn :service="productApi.luteosProductAmazonOperatorCheckDownload" :params="search">
        导出
      </ExportBtn>
    </template>
    <el-table
...
import useList from '@/hooks/list/useList';
  ...
  import DetailDialog from '@/views/goodscenter/goodsmanage/skurelation/components/detailDialog.vue';
