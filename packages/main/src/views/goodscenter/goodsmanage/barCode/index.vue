<template>
  ...
  >
    ...
    <template #buttons>
      ...
      <ExportBtn :service="productApi.luteosProductBarcodeExport" :params="search">导出</ExportBtn>
    </template>
    <el-table
      ref="tableRef"
...
<script setup lang="ts" name="barCode">
  ...
  import AddDialog from '@/views/goodscenter/goodsmanage/barCode/components/addDialog.vue';
