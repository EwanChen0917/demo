    ...
    <div class="d-flex gap-5">
      <KeenCard title="" class="tab-card">
        <el-tabs v-model="tabCurrent">
          ...
          <el-tab-pane label="采购信息" :name="10">
            <KeenCard>
              <div class="item-grid">
                ...
                <el-form-item label="执行采购：">
                  {{ form?.purchaseInfo?.purchaserName }}
                </el-form-item>
                <el-form-item label="战略采购：">
                  {{ form?.purchaseInfo?.strategicPurchaserName }}
                </el-form-item>
          ...
          <template v-if="isMaterial">
            <el-tab-pane label="财务信息" :name="15">
              <KeenCard>
                <el-form-item label="费用归属SPU">
                  <span>
                    {{
                      `${form?.financeInfo?.costProductName} ${form?.financeInfo?.costProductSpu}` ||
                      '-'
                    }}
                  </span>
                </el-form-item>
                ...
                <el-form-item label="费用归属品线：">
                  <span>{{ form?.financeInfo?.costProductLineDesc || '-' }}</span>
                </el-form-item>
                <el-form-item label="费用归属分类：">
