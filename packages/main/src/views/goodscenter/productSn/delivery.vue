<template>
  ...
  >
    ...
    <template #filters>
      <el-input v-model="search.keyword" placeholder="订单号" clearable style="width: 350px">
        <template #suffix>
          <i class="iconfont icon-sousuo"></i>
        </template>
        <template #prepend>
          <el-select :style="{ width: '110px' }" v-model="search.keyType">
    ...
    >
      ...
      <el-table-column label="出库单号/调拨单号" prop="outBoundCode" :width="150" />
