        ...
        <div class="detail-left" ref="detailLeftRef">
          ...
          <el-form label-width="376px" label-position="left">
            ...
            <div class="milestones" style="margin-top: 6px; margin-bottom: 24px">
              ...
              >
                <!-- 任务标题 列 -->
                <el-table-column label="任务标题" align="left">
                  <template #header>
                  ...
                  <template #default="{ row, $index }">
                    ...
                    <template v-else-if="$index === 2">
                      ...
                      <EllipsisExpandable v-else :text="row.detail" :line-clamp="2" />
                    </template>
                  </template>
                </el-table-column>
                <!-- 任务来源 列 -->
            ...
            <template v-if="!taskDetail?.parentTaskCode">
              ...
              >
                ...
                <el-table-column label="子任务标题" align="center" width="180" fixed="left">
                  <template #header>
                    <div style="width: 100%" class="required-label">子任务标题</div>
                  </template>
                  <template #default="{ row }">
                    <el-input
                      v-if="row.isEditing"
                ...
                <el-table-column label="任务类别" align="center" width="150">
                  <template #header>
                    <div style="width: 100%" class="required-label">任务类别</div>
                  </template>
                  <template #default="{ row }">
                    <el-select
                      id="categorySelectRef"
                ...
                <el-table-column label="任务来源" align="center" width="150">
                  <template #header>
                    <div style="width: 100%" class="required-label">任务来源</div>
                  </template>
                  <template #default="{ row }">
                    <el-select
                      v-if="row.isEditing"
                ...
                <!-- 执行人 -->
                <el-table-column label="共同执行人" align="center" width="200">
                  <template #header>
                    <div style="width: 100%">
                ...
                <el-table-column label="执行者" align="center" width="120">
                  <template #header>
                    <div style="width: 100%" class="required-label">执行者</div>
                  </template>
                  <template #default="{ row }">
                    <DeptMember
                      v-if="row.isEditing"
                ...
                <el-table-column label="任务完成确认人" align="center" width="130">
                  <template #header>
                    <div style="width: 100%" class="required-label">任务完成确认人</div>
                  </template>
                  <template #default="{ row }">
                    <DeptMember
                      v-if="row.isEditing"
                ...
                <el-table-column label="创建人" align="center" width="120">
                  <template #header>
                    <div style="width: 100%" class="required-label">创建人</div>
                  </template>
                  <template #default="{ row }">
                    <div class="cell-with-avatar">
                ...
                <el-table-column label="截止时间" align="center" width="120">
                  <template #header>
                    <div style="width: 100%" class="required-label">截止时间</div>
                  </template>
                  <template #default="{ row }">
                    <el-date-picker
                      v-if="row.isEditing"
                ...
                <el-table-column label="任务详情说明" align="center" width="180">
                  <template #header>
                    <div style="width: 100%" class="required-label">任务详情说明</div>
                  </template>
                  <template #default="{ row }">
...
<script setup lang="ts" name="taskManageDetail">
