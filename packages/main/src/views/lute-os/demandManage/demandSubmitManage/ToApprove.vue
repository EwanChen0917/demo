<template>
  <KeenList :selected-num="0" :selected-list="[]" @resetSearch="reset" @refresh="runQuery">
    ...
    >
      ...
      <el-table-column fixed="right" label="需求附件" prop="userResearchFile.name" width="180">
        <template #default="{ row }">
...
<script lang="ts" setup name="demandSubmitToApprove">
