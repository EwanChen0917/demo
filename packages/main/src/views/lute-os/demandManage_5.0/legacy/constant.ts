...
export const UserResearchReportPermission = {
  ViewOnly: 'view_only',
  ViewDownload: 'view_download',
  Private: 'private',
} as const;

export const UserResearchReportPermissionLabelMap = {
  view_only: '仅查看',
  view_download: '查看+下载',
  private: '私密',
} as const;

export const UserResearchReportPermissionOptions = [
  { label: '仅查看', value: UserResearchReportPermission.ViewOnly },
  { label: '查看+下载', value: UserResearchReportPermission.ViewDownload },
  { label: '私密', value: UserResearchReportPermission.Private },
];
