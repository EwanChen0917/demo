  ...
  <el-dialog :title="title" v-model="visible" @close="visible = false">
    <el-radio-group v-model="operateType">
      <div class="d-flex w-100 mb-3 gap-20">
        <el-radio label="batch_update_pro_manager" class="w-200px">更新产品经理</el-radio>
        <OperatorSelect
      ...
      <div class="d-flex w-100 mb-3 gap-20">
        <el-radio label="batch_update_gtm_manager" class="w-200px">更新GTM经理</el-radio>
        <DeptMember
      ...
      <div class="d-flex w-100 mb-3 gap-20">
        <el-radio label="batch_rel_label" class="w-200px">关联SPU标签</el-radio>
        <ProductTagSelect
