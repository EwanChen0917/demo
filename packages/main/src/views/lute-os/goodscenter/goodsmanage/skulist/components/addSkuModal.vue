...
<script lang="ts" setup>
  ...
  import BindSku from '@/views/lute-os/goodscenter/goodsmanage/skurelation/components/bindSku.vue';
  import { IDickbook } from '@/views/lute-os/goodscenter/goodsmanage/skulist/data';
  import OnlineGoodsModal from '@/views/lute-os/goodscenter/goodsmanage/skurelation/components/onlineGoodsModal.vue';
