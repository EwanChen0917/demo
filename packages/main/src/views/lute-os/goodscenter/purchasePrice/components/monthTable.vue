...
<script setup lang="ts">
  ...
  const {
    ...
    DataApi.LuteosDataQueryFinanceSkuPurchasePriceList.RequestQuery,
    DataApi.LuteosDataQueryFinanceSkuPurchasePriceList.ResponseBody
  >({
    searchDefaults: {
      keyword: undefined,
    },
    ...
    pageSize: PAGE_SIZE,
    service: dataApi.luteosDataQueryFinanceSkuPurchasePriceList,
  });
