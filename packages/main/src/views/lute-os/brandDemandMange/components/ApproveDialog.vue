<template>
  <el-dialog v-model="visible" title="审批通过" width="500px" @close="handleCancel">
    <el-form :model="form" :rules="rules" label-width="150px" ref="formRef">
      <el-form-item label="选择需求执行人" prop="operator">
        <DeptMember v-model="form.operator" :maxCollapseTags="1" :deptId="props.userInfo.deptInfo.deptId" :teleported="true" />
      </el-form-item>
...
const form = reactive({
  operator: props.userInfo.memberCode,
  planStartDate: '',
  planFinishDate: ''
})
const rules = {
