  ...
  <el-form :model="form" style="max-width: 800px" ref="formRef" :rules="rules" label-width="140px">
    ...
    <template v-if="form.remindFlag">
      ...
      <el-form-item label="推送内容">
        <el-input v-model="form.remindContent" maxlength="100" show-word-limit />
      </el-form-item>
    </template>
    <el-form-item label="学习模式">
      <el-select v-model="form.learningWay" placeholder="请选择课程学习模式">
        <el-option label="自由式学习" :value="0" />
        <el-option label="解锁式学习" :value="1" />
      </el-select>
    </el-form-item>
    <el-form-item label="课程评价">
      <el-select v-model="form.courseEvaluate" placeholder="请选择课评价方式">
