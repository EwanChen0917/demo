<template>
  <KeenList>
    ...
    <template #buttons>
      ...
      <ExportBtn :ignore-app-code="true" :service="platformApi.platformEntertainExportEntertain" :params="search">
        导出
      </ExportBtn>
    </template>
    <el-table
    ...
    >
      ...
      <el-table-column prop="creatorName" label="创建人" min-width="140px" />
...
<script lang="ts" setup name="externalReceptionRecord">
