...
<script setup lang="ts" name="metaTeam">
  import useList from '@/hooks/list/useList';
  import TeamDialog from '@/views/metaTeamManage/components/teamDialog.vue';
  import * as swal from '@/utils/swal';
  import { memberApi, productOperationApi, ProductOperationApi } from '@/api';
  import { ElMessage } from 'element-plus';
  import TeamDetailDialog from '@/views/metaTeamManage/components/teamDetailDialog.vue';
