  ...
  <el-dialog :model-value="visible" @close="handleCancel" width="75%" top="1vh" @open="runQuery">
    ...
    <div class="card card-flush">
      ...
      <div class="card-body pt-0">
        ...
        >
          <el-table-column width="70" align="center" v-if="selectOne">
...
<script lang="ts" setup>
  ...
  const {
    ...
    ProductApi.LuteosProductPromotionPlanQuerySpuList.RequestQuery,
    ProductApi.LuteosProductPromotionPlanQuerySpuList.ResponseBody
  >({
    searchDefaults: {
      keyWord: undefined,
    ...
    pageSize: PAGE_SIZE,
    service: productApi.luteosProductPromotionPlanQuerySpuList,
  });
