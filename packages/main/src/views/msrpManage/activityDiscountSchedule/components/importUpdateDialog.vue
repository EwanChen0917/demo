<template>
  <el-dialog :title="title" v-model="visibility" width="400px" :before-close="close">
...
<script setup lang="ts">
  ...
  const serviceMap = {
    batchUpdate: {
      template: erpApi.luteosErpCartonSizeDownTemplate,
      upload: erpApi.luteosErpCartonSizeUpload,
    },
  };
