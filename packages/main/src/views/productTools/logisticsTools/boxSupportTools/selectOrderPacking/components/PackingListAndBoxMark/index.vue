...
<script lang="ts" setup>
  ...
  import PackingList from '@/views/productTools/logisticsTools/boxSupportTools/selectOrderPacking/components/PackingListAndBoxMark/components/PackingList/index.vue';
  import BoxMark from '@/views/productTools/logisticsTools/boxSupportTools/selectOrderPacking/components/PackingListAndBoxMark/components/BoxMark/index.vue';
